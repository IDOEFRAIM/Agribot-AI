...
class ClimateVigilance:
    def __init__(self, llm_client=None, model_name="llama3:8b"):
        ...
        try:
            ...
            logger.error(f"❌ Échec initialisation Groq: {e}")
            self.llm = None
    ...
    def validate_and_calculate(self, state: AgentState) -> Dict[str, Any]:
        ...
        # we simulate rh
        w["rh"] = 20.0 if w.get("rh") is None else w.get("rh")
        # 1. Validation de présence
        required_weather = ["t_min", "t_max", "precip"]
